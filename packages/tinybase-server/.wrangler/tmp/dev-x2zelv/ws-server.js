...
// ../../node_modules/.pnpm/tinybase@5.4.8_@cloudflare+workers-types@4.20250224.0_prettier@3.5.2_react-dom@19.0.0_r_f119fa6fd70ae136b14596e010fc1b02/node_modules/tinybase/index.js
...
// ../../node_modules/.pnpm/tinybase@5.4.8_@cloudflare+workers-types@4.20250224.0_prettier@3.5.2_react-dom@19.0.0_r_f119fa6fd70ae136b14596e010fc1b02/node_modules/tinybase/persisters/persister-durable-object-storage/index.js
var EMPTY_STRING2 = "";
var T = "t";
var V = "v";
var UNDEFINED = "\uFFFC";
...
// ../../node_modules/.pnpm/tinybase@5.4.8_@cloudflare+workers-types@4.20250224.0_prettier@3.5.2_react-dom@19.0.0_r_f119fa6fd70ae136b14596e010fc1b02/node_modules/tinybase/synchronizers/synchronizer-ws-server-durable-object/index.js
...
// api.ts
function processQueryParameters(store, queries, tableId, params) {
    ...
    params.forEach((value, key) => {
      ...
      try {
        ...
        switch (operator) {
          ...
          case "$ne":
            where((getCell) => {
              const value2 = getCell(field);
              return value2 !== void 0 ? value2 !== parsedValue : false;
            });
            break;
          case "$gt":
            where((getCell) => {
          ...
          case "$in":
            where((getCell) => {
              ...
              const value2 = getCell(field);
              return value2 !== void 0 ? parsedValue.includes(value2) : false;
            });
            break;
          case "$nin":
            where((getCell) => {
...
__name(processQueryParameters, "processQueryParameters");
...
// ws-server.ts
var PERSIST_TO_DURABLE_OBJECT = true;
var TinyBaseDurableObject = class extends WsServerDurableObject {
  ...
  onClientId(pathId, clientId, addedOrRemoved) {
    console.info(
      (addedOrRemoved > 0 ? "Added" : "Removed") + ` client ${clientId} on path ${pathId}`
    );
  }
  createPersister() {
...
var getClientId2 = /* @__PURE__ */ __name((request) => request.headers.get("upgrade")?.toLowerCase() == "websocket" ? request.headers.get("sec-websocket-key") : null, "getClientId");
var PATH_REGEX2 = /\/([^?]*)/;
var getPathId2 = /* @__PURE__ */ __name((request) => {
  ...
  const pathId = pathname.match(PATH_REGEX2)?.[1] ?? "";
  console.log("pathId", { pathname, pathId });
  return pathId;
}, "getPathId");
var getWsServerDurableObjectFetch = /* @__PURE__ */ __name((namespace) => (request, env) => {
  ...
  if (getClientId2(request) || request.url.includes("__api__")) {
    const id2 = DO.idFromName(getPathId2(request));
    console.log("id", id2);
    return DO.get(id2).fetch(request);
  } else {
    return new Response("Upgrade required", { status: 426 });
  }
}, "getWsServerDurableObjectFetch");
var ws_server_default = {
  fetch: async (request, env) => {
    return getWsServerDurableObjectFetch("TinyBaseDurableObject")(request, env);
  }
};

// ../../node_modules/.pnpm/wrangler@3.111.0_@cloudflare+workers-types@4.20250224.0/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../node_modules/.pnpm/wrangler@3.111.0_@cloudflare+workers-types@4.20250224.0/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-9olDYn/middleware-insertion-facade.js
var __INTERNAL_WRANGLER_MIDDLEWARE__ = [
  middleware_ensure_req_body_drained_default,
  middleware_miniflare3_json_error_default
];
var middleware_insertion_facade_default = ws_server_default;

// ../../node_modules/.pnpm/wrangler@3.111.0_@cloudflare+workers-types@4.20250224.0/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-9olDYn/middleware-loader.entry.ts
